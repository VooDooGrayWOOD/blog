...
const Main = () => {
    return (
        <div className="container mx-auto max-w-[760px] text-teal-700">
            <div className="bg-[--secondary]">
                <div className="mx-auto grid max-w-2xl grid-cols-1 items-center gap-y-16 gap-x-8 py-14 px-4 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
                    <div>
