...
export default function Example() {
    return (
        <Disclosure as="nav" className="bg-nav-green">
            {({ open }) => (
                <>
                    <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                        <div className="relative flex items-center justify-between h-28">
                                        ...
                                        {navigation.map((item) => (
                                            <Link
                                                ...
                                                className={classNames(
                                                    ...
                                                    'px-3 py-2 rounded-md text-[1.6rem] font-medium'
                                                )}
                                                aria-current={
                                                    item.current
                                                        ? 'page'
                            ...
                            <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                                <button
                                    type="button"
                                    className="bg-gray-800 p-1 mx-4 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
                                >
                                    <span className="sr-only">
                                        View notifications
                                    </span>
                                ...
                                <Disclosure.Button
                                    ...
                                    className={classNames(
                                        item.current
                                            ? 'bg-gray-900 text-white'
                                            : 'text-gray-300 hover:bg-gray-700 hover:text-white',
                                        'block px-3 py-2 rounded-md text-[1.6rem] font-medium'
                                    )}
                                    aria-current={
