...
const Main = () => {
    return (
        <div className="container mx-auto max-w-[760px] pt-5 text-teal-700 text-3xl">
            ...
            <div>
            <h2 className="text-3xl font-extrabold tracking-tight text-teal-700 sm:text-4xl">Technical Specifications</h2>
        ...
        {features.map((feature) => (
            ...
            <dt className="font-medium text-teal-700">{feature.name}</dt>
            <dd className="mt-2 text-[1.2rem] text-gray-500">{feature.description}</dd>
            </div>
            ))}
            </dl>
            </div>
